    ...
    var N = function(h) {
        ...
        function Da(a) {
            ...
            for (f = b.length; e < f; e++)
                ...
                g = 0;
                for (j = d.length; g < j; g++) { i = 0; for (h = c.length; i < h && !(k[i] === l && (k[i] = A(a, i, e, "type")), n = d[g](k[i], a), !n || "html" === n); i++); if (n) { m.sType = n; break } }
            ...
            if (b)
                for (e = b.length - 1; 0 <= e; e--) {
                    ...
                    for (g = n.length; f < g; f++)
                        ...
                        n[f], o);
                    else if ("string" === typeof n[f]) { j = 0; for (i = m.length; j < i; j++)("_all" == n[f] || h(m[j].nTh).hasClass(n[f])) && d(j, o) }
                }
        ...
        function ia(a, b) {
            var c = [],
                ...
                f, g, j, i = 0,
                o, m = a.aoColumns,
                n = function(a, b, c) { "string" === typeof a && (b = a.indexOf("@"), -1 !== b && (a = a.substring(b + 1), j["@" + a] = c.getAttribute(a))) },
                k = function(a) {
                    g = m[i];
            ...
            for (var f = a.sDom.split(""), g, j, i, o, m, n, k = 0; k < f.length; k++) {
                ...
                if ("<" == j) {
                    ...
                    for (o = i.length; n < o; n++)
                        if (j == i[n].cFeature) { g = i[n].fnInit(a); break }
                }
            ...
            for (i = c.length; f < i; f++) {
                ...
                for (e = d.firstChild; e;) {
                    if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                        ...
                        k = 1 === m ? !0 : !1;
                        for (j = 0; j < m; j++)
                            for (g = 0; g < n; g++) a[f + g][o + j] = { cell: e, unique: k }, a[f + g].nTr = d
                    }
                    e = e.nextSibling
                }
            }
        ...
        function W(a) {
            ...
            g = q.outerWidth();
            if ("" === c) { if (M.width = "100%", v && (q.find("tbody").height() > i.offsetHeight || "scroll" == n.css("overflow-y"))) M.width = s(q.outerWidth() - f) } else "" !== d ? M.width = s(d) : g == n.width() && n.height() < q.height() ? (M.width = s(g - f), q.outerWidth() > g - f && (M.width = s(g))) : M.width = s(g);
            g = q.outerWidth();
            F(E, x);
            F(function(a) {
                    C.push(a.innerHTML);
        ...
        function Ca(a) {
            ...
            o && (b.style.width = s(o));
            if ((o || f) && !a._reszEvt) h(za).bind("resize.DT-" + a.sInstance, Ma(function() { V(a) })), a._reszEvt = !0
        }
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) P(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    for (i = n.length; j < i; j++) {
                        if (n[j].nTable == this) { i = g.bRetrieve !== l ? g.bRetrieve : m.bRetrieve; if (c || i) return n[j].oInstance; if (g.bDestroy !== l ? g.bDestroy : m.bDestroy) { n[j].oInstance.fnDestroy(); break } else { P(n[j], 0, "Cannot reinitialise DataTable", 3); return } }
                        if (n[j].sTableId ==
            ...
            function(a, b, c) {
                ...
                if (null === b || b === l) return this.iterator("table", function(b) {
                    ...
                    return Za(d, function(a) {
                        if (a === null || a === l) {
                            o = [];
                            p = 0;
                            for (r = g.length; p < r; p++) { j = g[p]; for (q = 0; q < m; q++) o.push({ row: j, column: q }) }
                            return o
                        }
                ...
                var d = this.columns(b, c),
                    ...
                    f, g, j, i, o, m = this.iterator("table", function(a, b) {
                        f = [];
                        g = 0;
                        for (j = e[b].length; g < j; g++) { i = 0; for (o = d[b].length; i < o; i++) f.push({ row: e[b][g], column: d[b][i] }) }
                        return f
                    });
        ...
        p.isDataTable = p.fnIsDataTable = function(a) {
            var b = h(a).get(0),
                c = !1;
            h.each(p.settings,
                function(a, e) { if (e.nTable === b || e.nScrollHead === b || e.nScrollFoot === b) c = !0 });
            return c
        };
