                        ...
                        function (a, b, c) { return this.iterator("table", function (d) { Ka(d, a, b, c) }) }); r(["columns().order()", "column().order()"], function (a) { var b = this; return this.iterator("table", function (c, d) { var e = []; h.each(b[d], function (b, c) { e.push([c, a]) }); c.aaSorting = e }) }); r("search()", function (a, b, c, d) {
                            ...
                            fnStateLoadParams: null, fnStateLoaded: null, fnStateSaveCallback: function (a, b) { try { (-1 === a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b)) } catch (c) { } }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
                                oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: {
                                    sFirst: "", sLast: "",
                                    sNext: "", sPrevious: ""
                                }, sEmptyTable: "", sInfo: "", sInfoEmpty: "", sInfoFiltered: "", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Afficher _MENU_ personnes", sLoadingRecords: "Chargement...", sProcessing: "Chargement...", sSearch: "Recherche:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "Aucun résultat trouvé"
